...
public class Main {
    ...
    public static final String TEXT_DATA_FILE = "data.txt";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Все передачи, отсортированные по каналу и времени");
        programs.forEach(program -> System.out.println(program.toString()));
        System.out.println("Все передачи, которые идут сейчас");
    ...
    public static void writeToFile(List<Program> programs) {
        try (FileOutputStream outputStream = new FileOutputStream(EXCEL_DATA_FILE)) {
            ...
            for (int i = 0; i < programs.size(); i++) {
                ...
                sheet.getRow(i).getCell(0).setCellValue(programs.get(i).toString());
            }
